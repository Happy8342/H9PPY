...
if 'aarch64' in str(current_os):
    ...
    if not os.path.isfile('a64'):
        ...
        os.system('curl -L https://github.com/happy16/files/blob/main/hop/for_termux/aarch64/a64?raw=true > a64')
    ...
    if not os.path.isfile('a32'):
        ...
        os.system('curl -L https://github.com/happy16/files/blob/main/hop/for_termux/arm/a32?raw=true > a32')
    ...
    print('  Owner whatsapp: +9176197-97917\n\n')
